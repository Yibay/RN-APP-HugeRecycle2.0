package com.huge_recycle_android.android_umeng_analytics;
...
public class DplusReactPackage implements ReactPackage {
    ...
    public List<NativeModule> createNativeModules(
        ...
        MobclickAgent.setScenarioType(reactContext.getApplicationContext(), MobclickAgent.EScenarioType.E_DUM_NORMAL);
