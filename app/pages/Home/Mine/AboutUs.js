    ...
    return <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <TextAdaption style={styles.intro}>
          “虎哥回收”是浙江九仓环境有限公司旗下的“互联网+生活垃圾分类回收”品牌特色项目，专注于城市居民生活垃圾分类和再生资源回收，通过互联网、物联网、大数据与信息管理公共平台等现代信息技术手段，打造了一条“家庭垃圾袋—小区服务站—清运车—分选总仓”的垃圾分类处置高速公路，开创了中国城市垃圾分类回收和再生资源综合利用的新模式，实现生活垃圾减量化、资源化、无害化处理，为城市生态文明建设和循环经济发展贡献力量。
        </TextAdaption>
