...
class ForgetLoginPassword extends Component {
  ...
  async submit() {
    ...
    const res = await request.postFormData(config.api.updatePassword,{oldPassword: this.state.code, newPassword: this.state.newPassword}, {'X-AUTH-TOKEN': this.props.identityToken.authToken})
    console.log(res);
    if(res){
